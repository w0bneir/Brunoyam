...
con.commit()
cur.execute('''create table Likes (like_id integer primary key,
                                   user_id integer not null,
...
con.commit()
cur.execute('''create table Comments (comment_id integer primary key,
                                      user_id integer not null,
                                      post_id integer not null,
                                      content text not null,
                                      creation_date datetime default current_timestamp,
                                      ...
                                      foreign key (post_id) references Posts(post_id))''')
con.commit()
con.execute('''create table Groups (group_id integer primary key,
...
con.commit()
cur.execute('''create table GroupMembers (member_id integer primary key,
